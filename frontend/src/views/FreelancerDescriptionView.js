        ...
        <div className={styles.center}>
          {/* Image not loaded from freelancer card */}
            <img className={styles.imageStyle} src={mechanic}/>
             <br/>
             <div className={styles.center}>
                 <h3>{this.state.freelancer.freelancerName} {this.state.freelancer.surname}</h3>
                 <h4>{this.state.freelancer.role}</h4>
            ...
            <Box display="flex" 
                ...
                <ListItem>
                    ...
                    <ListItemText primary="Expertise" secondary={this.state.freelancer.expertise} />
                </ListItem>
                <ListItem>
                    <ListItemIcon> <BuildIcon /> </ListItemIcon>
                    <ListItemText primary="Inspections" secondary={this.state.freelancer.inspections} />
                </ListItem>
                <ListItem>
                    <ListItemIcon> <PhoneIcon /> </ListItemIcon>
                    <ListItemText primary="Telephone" secondary={this.state.freelancer.telephone} />
                </ListItem>
                <ListItem>
                    <ListItemIcon> <DraftsIcon /> </ListItemIcon>
                    <ListItemText primary="E-mail" secondary={this.state.freelancer.email} />
                </ListItem>
                <ListItem>
                    <ListItemIcon> <RoomIcon /> </ListItemIcon>
                    <ListItemText primary="City" secondary={this.state.freelancer.city} />
                </ListItem>
                </List>
            </Box>
