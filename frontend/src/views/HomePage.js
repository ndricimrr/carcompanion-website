          ...
          <div className={styles.container}>
            ...
            <div className={styles.rowCenterText}>
              <div className={styles.column}>
                ...
                <div className={styles.centeredTextOnImg}>
                  1. Find your dream car
                </div>
                <div className={styles.smallTextOnImg}>
                  A user friendly and intelligent search engine for the car that
              ...
              <div className={styles.column}>
                ...
                <div className={styles.centeredTextOnImg}>
                  2. Get free expert inspection
                </div>
                <div className={styles.smallTextOnImg}>
                  We match you with experts that help you with inspection when
              ...
              <div className={styles.column}>
                ...
                <div className={styles.centeredTextOnImg}>
                  3. Convenient maintenance & repair
                </div>
                <div className={styles.smallTextOnImg}>
                  We match you with freelance mechanics in your neighborhood for
              ...
              <div className={styles.column}>
                ...
                <div className={styles.centeredTextOnImg}>
                  4. Be part of a great community
                </div>
                <div className={styles.smallTextOnImg}>
                  A community that relies car experts, enthusiasts and owners -
                  the Stackoverflow for cars.
                </div>
              </div>
            </div>
          </div>
